...
namespace project_ticket.Migrations
{
    ...
    [Migration("20230318143022_cambiosIdentidad")]
    partial class cambiosIdentidad
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("project_ticket.Models.Asiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("project_ticket.Models.Compra", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("project_ticket.Models.Entrada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("project_ticket.Models.Escenario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("project_ticket.Models.Evento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("project_ticket.Models.TipoEscenario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("project_ticket.Models.TipoEvento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int(11)")
            ...
            modelBuilder.Entity("project_ticket.Models.Asiento", b =>
                {
                    b.HasOne("project_ticket.Models.Escenario", "IdEscenarioNavigation")
                        .WithMany("Asientos")
            ...
            modelBuilder.Entity("project_ticket.Models.Compra", b =>
                {
                    b.HasOne("project_ticket.Models.Entrada", "IdEntradaNavigation")
                        .WithMany("Compras")
            ...
            modelBuilder.Entity("project_ticket.Models.Entrada", b =>
                {
                    b.HasOne("project_ticket.Models.Evento", "IdEventoNavigation")
                        .WithMany("Entrada")
            ...
            modelBuilder.Entity("project_ticket.Models.Evento", b =>
                {
                    ...
                    b.HasOne("project_ticket.Models.TipoEvento", "IdTipoEventoNavigation")
                        .WithMany("Eventos")
